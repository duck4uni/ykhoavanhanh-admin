    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Thêm dịch vụ khám</h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Tạo mới dịch vụ khám, thiết lập giá, loại bảo hiểm và chuyên khoa.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr] lg:items-start">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            >
              {createMutation.isPending && <Spinner size="sm" />}Tạo dịch vụ
            </button>
            <button
              type="button"
              onClick={() => router.push("/exam-services")}
